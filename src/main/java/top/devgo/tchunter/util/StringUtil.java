...
public class StringUtil {
    ...
    /**
     * 判断字符串是否有意义：去除特殊符号后，是否只包含中文,日文,英文,数字
     * @param strName
     * @return
     */
	public static boolean isMeanful(String strName) {
		strName = strName.replaceAll("((?=[\\x21-\\x7e]+)[^A-Za-z0-9])", "").replaceAll(" ", "");
		String regex = "[\\w\u4E00-\u9FA5\u3040-\u309F\u30A0-\u30FF]+$";
		Pattern pattern = Pattern.compile(regex);
		Matcher match = pattern.matcher(strName);
